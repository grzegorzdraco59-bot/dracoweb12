...
/// <summary>
/// Interfejs serwisu aplikacyjnego dla kontrahenta (Customer)
...
public interface ICustomerService
{
    ...
    Task<CustomerDto?> GetByKontrahentIdAsync(int kontrahentId, int companyId, CancellationToken cancellationToken = default);
